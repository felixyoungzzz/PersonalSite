...
module.exports = "    <div class=\"style-editor\" id=\"style-box\">\r\n        <div class=\"header header-clicked\">\r\n            <div class=\"toolbar\">\r\n                <div class=\"buttons\">\r\n                    <div class=\"system-buttons\">\r\n                        <div class=\"circle red\"></div>\r\n                        <div class=\"circle yellow\"></div>\r\n                        <div class=\"circle green\"></div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"title title-clicked\">style\r\n                <span class=\"edited\">— Edited</span>\r\n            </div>\r\n        </div>\r\n        <div class=\"text-content\">\r\n            <pre contenteditable=\"true\" id=\"style-text\"></pre>\r\n        </div>\r\n    </div>"
...
var _masterContent = __webpack_require__(12);

var _masterContent2 = _interopRequireDefault(_masterContent);

var _styleEditor = __webpack_require__(2);

var _styleEditor2 = _interopRequireDefault(_styleEditor);

var _masterEditor = __webpack_require__(13);

var _masterEditor2 = _interopRequireDefault(_masterEditor);

var _trickEditor = __webpack_require__(14);

var _trickEditor2 = _interopRequireDefault(_trickEditor);

var _item = __webpack_require__(15);

var _item2 = _interopRequireDefault(_item);

var _sleep = __webpack_require__(16);

var _writeChar = __webpack_require__(17);

var _writeChar2 = _interopRequireDefault(_writeChar);

var _click = __webpack_require__(18);

var _item3 = __webpack_require__(19);
...
var _item4 = __webpack_require__(26);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var styleMsg = [0, 1, 2].map(function (i) {
    return __webpack_require__(27)("./style" + i + '.txt');
});
...
async function start() {
    try {
        ...
        await createEditor('desktop', _styleEditor2.default);
        createEditor('desktop', _masterEditor2.default);
        createEditor('desktop', _trickEditor2.default);
        var styleText = document.getElementById('style-text');
        await writeTo(styleText, styleMsg[0].replace(/[\n]/ig, ''), true, 16, 0, 1);
        ...
        var Boxs = [masterBox, styleBox, gameBox, trickBox];
        (0, _click.changeEditor)(masterBox, styleBox);
        addmasterContent();
        await (0, _click.changeEditor)(styleBox, masterBox);
        await writeTo(styleText, styleMsg[1].replace(/[\n]/ig, ''), true, 16, 0, 1);
        await await (0, _item3.createItem)(_item4.itemsmsg, _item2.default);
        await (0, _sleep.sleep)(1000);
        showGameAndTrick();
        await writeTo(styleText, styleMsg[2].replace(/[\n]/ig, ''), true, 16, 0, 1);
        await clearTransition();
        addDraggable(Boxs);
        (0, _item3.addSVGmousemoveListener)();
        (0, _click.addClickListener)(Boxs);
...
(function () {
    document.onreadystatechange = function () {
        ...
        if (document.readyState == "Uninitialized") {
            _nprogress2.default.set(1);
        }
        if (document.readyState == "complete") {
            (function () {
                for (var i = 1; i <= 70; i++) {
                    (0, _sleep.sleep)(1000);
                    _nprogress2.default.set(0.8 / 70 + 0.2);
                }
            })();
        }
    };
...
async function writeTo(el, msg, mirrortostyle, interval, index, charsPerInterval) {
    var chars = msg.slice(index, index + charsPerInterval);
    index += charsPerInterval;
    el.scrollTop = el.scrollHeight;

    if (mirrortostyle) {
        (0, _writeChar2.default)(el, chars, style);
    } else {
        (0, _writeChar.writeSimpleChar)(el, chars);
    }

    if (index < msg.length) {
        var thisInterval = interval;
        var thisSlice = msg.slice(index - 2, index + 1);
        ...
        try {
            await (0, _sleep.sleep)(thisInterval);
        } catch (err) {
            console.log(err);
        }
...
function showGameAndTrick() {
    ...
    document.getElementById('game-title').innerHTML = 'Run as far as you can by using ↑ & ↓';
...
function addDraggable(els) {
    ...
    for (var i = 0; i < length; i++) {
        $(els[i]).draggable({
            handle: $(els[i]).children('.header').first()
        });
    }
}

function addmasterContent() {
    var masterText = document.getElementById('master-text');
    masterText.innerHTML = _masterContent2.default;
}
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_postcss-loader@2.0.9@postcss-loader/lib/index.js!./editor.css", function() {
			var newContent = require("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_postcss-loader@2.0.9@postcss-loader/lib/index.js!./editor.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_postcss-loader@2.0.9@postcss-loader/lib/index.js!./master-content.css", function() {
			var newContent = require("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_postcss-loader@2.0.9@postcss-loader/lib/index.js!./master-content.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_postcss-loader@2.0.9@postcss-loader/lib/index.js!./animate.css", function() {
			var newContent = require("!!../../node_modules/_css-loader@0.28.7@css-loader/index.js!../../node_modules/_postcss-loader@2.0.9@postcss-loader/lib/index.js!./animate.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = "<div class=\"m-content\">\r\n            <div class=\"m-title\">我是|<span>I am</span>\r\n            </div>\r\n            <p>一名正在努力学习的打码人员/一只喜欢听音乐唱歌的杰迷学友迷Eason迷五月天迷/</p>\r\n            <p>一个“阅片经历“颇丰的正经电影观众</p>\r\n            <p>还有...</p>\r\n            <p>近似疯狂的吸猫患者</p>\r\n        </div>"

/***/ }),
/* 13 */
/***/ (function(module, exports) {

module.exports = "    <div class=\"master-editor\" id=\"master-box\">\r\n        <div class=\"header header-unclicked\">\r\n            <div class=\"toolbar\">\r\n                <div class=\"buttons\">\r\n                    <div class=\"system-buttons\">\r\n                        <div class=\"circle gray\"></div>\r\n                        <div class=\"circle gray\"></div>\r\n                        <div class=\"circle gray\"></div>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"title title-unclicked\">About me\r\n                <span class=\"edited\">— Edited</span>\r\n            </div>\r\n        </div>\r\n        <div class=\"text-content\">\r\n            <div class=\"container\">\r\n               <div id=\"master-text\">\r\n               </div>\r\n               <div class=\"items\">\r\n               </div>\r\n            </div>\r\n        </div>\r\n    </div>"

/***/ }),
/* 14 */
/***/ (function(module, exports) {

module.exports = "<div class=\"trick-editor\" id=\"trick-box\">\r\n            <div class=\"header header-unclicked\">\r\n                <div class=\"toolbar\">\r\n                    <div class=\"buttons\">\r\n                        <div class=\"system-buttons\">\r\n                            <div class=\"circle gray\"></div>\r\n                            <div class=\"circle gray\"></div>\r\n                            <div class=\"circle gray\"></div>\r\n                        </div>\r\n                    </div>\r\n                </div>\r\n                <div id=\"trick-title\" class=\"title title-unclicked\">\r\n                </div>\r\n            </div>\r\n            <div class=\"text-content\">\r\n                <img id=\"catgif\" ondragstart=\"return false;\">\r\n            </div>\r\n        </div>"

/***/ }),
/* 15 */
/***/ (function(module, exports) {

module.exports = "<svg preserveAspectRatio='xMidYMid slice' viewBox='0 0 300 200'>\r\n    <defs>\r\n        <clipPath id='clip-x'>\r\n            <circle cx='0' cy='0' fill='#000' r='150px'></circle>\r\n        </clipPath>\r\n    </defs>\r\n    <text class='svg-text' dy='.3em' x='50%' y='50%'>\r\n        \r\n    </text>\r\n    <g clip-path='url(#clip-x)'>\r\n        <image height='100%' preserveAspectRatio='xMinYMin slice' width='100%' xlink:href=''></image>\r\n        <text class='svg-masked-text' dy='.3em' x='50%' y='50%'>\r\n            \r\n        </text>\r\n    </g>\r\n</svg>"
...
exports.default = writeChar;
exports.writeSimpleChar = writeSimpleChar;
exports.handleChar = handleChar;
var styleBuffer = '';
var fullTextStorage = {};
...
exports.changeEditor = changeEditor;
var biggestZindex = 4;
function addClickListener(els) {
    ...
    els.forEach(function (el, index) {
        var button = $(el).find('.circle').first();
...
function changeToClickedStyle(el) {
    var header = $(el).children('.header').first();
    var title = $(el).find('.title').first();
    var buttons = $(el).find('.circle');
    var buttonStyle = ['red', 'yellow', 'green'];
...
exports.addSVGmousemoveListener = addSVGmousemoveListener;
function createItem(items, itemMsg) {
    var itemsHtml = document.querySelector('.items');
...
function addSVGmousemoveListener() {
    var items = [],
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../_css-loader@0.28.7@css-loader/index.js!../_postcss-loader@2.0.9@postcss-loader/lib/index.js!./nprogress.css", function() {
			var newContent = require("!!../_css-loader@0.28.7@css-loader/index.js!../_postcss-loader@2.0.9@postcss-loader/lib/index.js!./nprogress.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = {"itemsmsg":[{"text":"打码","path":"./src/image/01.gif","bgpath":"./src/image/01bg.jpg","href":"https://felixyoungzzz.github.io/"},{"text":"音乐","path":"./src/image/02.jpg","bgpath":"./src/image/02bg.jpg","href":"https://music.163.com/playlist?id=92663940&userid=82404596"},{"text":"电影","path":"./src/image/03.jpg","bgpath":"./src/image/03bg.jpg","href":"#"}]}
...
module.exports = "/**\r\n  * \r\n  * 你好.\r\n  * 我是Felix.\r\n  *\r\n  * 在进行自我介绍之前我们先来做一些酷酷的事情...\r\n  * \r\n  * 就是,\r\n  * 打代码.\r\n  */\r\n\r\n\r\n/**\r\n  * 听起来就很酷是不是.\r\n  * Let's go.\r\n  * \r\n  */\r\n\r\n* {\r\n    transition: all 1s;\r\n}\r\n\r\n\r\n/**\r\n  * 加了这个好像暂时没什么卵用.\r\n  * \r\n  * 马上你就会看到了.\r\n  * \r\n  */\r\n\r\n.style-editor {\r\n    left: 73%;\r\n    top: 5%;\r\n}\r\n\r\n\r\n/**\r\n  * 只有黑白好像很无趣.\r\n  *\r\n  * 毕竟,\r\n  * Color makes things beautiful.\r\n  *\r\n  * 让我们来加一点色彩吧.\r\n  */\r\n\r\n.comment { color: #857F6B;font-style: italic; }\r\n.selector { color: #5391CE; }\r\n.selector .key { color: #C42B23; }\r\n.key { color: #C42B23; }\r\n.value { color: #F38900; }\r\n.value.px { color: #4D4D4C; }\r\n\r\n/**\r\n  * \r\n  * 这样好看多了(不管，就是好看).\r\n  * \r\n  * 接下来该开始说正事了.\r\n  */\r\n\r\n.master-editor {\r\n    top: 10%;\r\n}\r\n\r\n"
